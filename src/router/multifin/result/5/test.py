...
policy_path = "ppo_router_policy_round10.pth" # Policy name matches the new task
# -----------------------------------------------------------
...
llm_system = HuggingFaceLLMSystem(model_names, NEWS_CATEGORIES, prompt_template=PROMPTS)

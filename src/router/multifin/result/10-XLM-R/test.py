...
def run_test():
    ...
    router.load_state_dict(torch.load("neural_bandit_buffer_embedding4.pth"))
    router.eval()

    output_csv = "test_detailed_results_buffer_xlmr4.csv"
    ...
    metrics_df.to_csv("language_wise_metrics_xlmr4.csv", index=False)
